    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dashboard/compras/ordenes/:id/ver" element={<GestionarCotizacionPage />} />
          <Route path="/dashboard/compras/ordenes/:id/asignar-precios" element={<AsignarPreciosPage />} />
